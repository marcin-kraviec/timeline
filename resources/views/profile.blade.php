    ...
    <div class="container content" style="max-width: 500px;">
        ...
        <form action="/profile" method="post">
            ...
            <div class="form-group">
                <label class="form-label mt-4">Aktualne hasło</label>
                <input type="password" name="password" class="form-control" id="inputUsername" placeholder="Wprowadź aktualne hasło" required>
            </div>
            <div class="form-group">
                <label class="form-label mt-4">Nowe hasło</label>
                <input type="password" name="newPassword" class="form-control" id="inputPassword" placeholder="Wprowadź nowe hasło" minlength="12" maxlength="100" required>
            </div>
            <div class="form-group">
                <label class="form-label mt-4">Potwierdź nowe hasło</label>
                <input type="password" name="newPassword_confirmation" class="form-control" id="inputPassword" placeholder="Potwierdź nowe hasło" minlength="12" maxlength="100" required>
            </div>
            <br/>
            <button type="submit" class="btn btn-primary" style="width: 100%">Zmień hasło</button>
            <br/><br/>
        </form>
    </div>
    <!-- MAIN CONTENT -->
